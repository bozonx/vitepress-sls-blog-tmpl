export function makeTagsList(allPosts = []) {
  const tags = {}
...
export function makeYearsList(allPosts = []) {
  const years = {}
...
export function makeMonthsList(allPosts = [], year) {
...
export function makePostOfMonthList(allPosts = [], year, month) {
  const curYear = Number(year)
